...
<div class="max-w-4xl mx-auto mt-10">
    ...
    <table id="sortableTable" class="min-w-full bg-white border border-gray-200 text-sm text-gray-700 mb-6">
        ...
        @foreach ($data as $item)
            <tr class="hover:bg-gray-50 cursos-pointer">
                ...
                <td class="py-2 px-4 border-b text-center" data-sort="{{$item->aprovados/$item->total}}">{{ number_format($item->porcentagem, 2) }}%</td>
            </tr>
        @endforeach
        </tbody>
    </table>
